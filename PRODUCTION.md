...
The supported compiler/runtime version is **Mako 0.5.0**. Use the same
0.5.0 compiler and runtime directory for C emission, native linking, the
...
links against the Mako 0.5.0 runtime. Do not mix a different compiler and
