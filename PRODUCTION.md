...
The supported compiler/runtime version is **Makori 0.6.32**. Use the same
0.6.32 compiler and runtime directory for C emission, native linking, the
...
links against the Makori 0.6.32 runtime. Do not mix a different compiler and
