...
func main() {
	...
	log.Printf("Smart Communications Proxy UI listening on %s", a.addr)
...
var pageTmpl = template.Must(template.New("page").Funcs(template.FuncMap{
	...
	"bar": barWidth,
}).Parse(`<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Smart Communications Proxy</title><script src="https://unpkg.com/htmx.org@2.0.4"></script><style>
